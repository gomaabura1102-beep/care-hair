...
export function AdminLoginForm() {
  ...
  return (
    <form onSubmit={submit} className="w-full max-w-md rounded-brand border border-line bg-white p-7 shadow-brand sm:p-10">
      ...
      <p className="mt-6 text-xs font-bold uppercase tracking-[0.18em] text-green">Care Hair Admin</p>
      <h1 className="mt-2 text-2xl font-semibold">運営者ログイン</h1>
      <p className="mt-3 text-sm leading-7 text-muted">Supabaseで管理者権限が付与されたアカウントだけが利用できます。</p>
